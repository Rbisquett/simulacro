...
class SedesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sede" do
    assert_difference('Sede.count') do
      post sedes_url, params: { sede: { ciudad: @sede.ciudad, nombre: @sede.nombre, numero_de_aforo: @sede.numero_de_aforo } }
    end
  ...
  test "should update sede" do
    patch sede_url(@sede), params: { sede: { ciudad: @sede.ciudad, nombre: @sede.nombre, numero_de_aforo: @sede.numero_de_aforo } }
